...
### Definition of Done
- [ ] `npm run build` 성공
- [ ] `npx vitest run` 85개+ 테스트 통과 (기존 테스트 깨지지 않음)
- [ ] 6개 뷰 + MemberHomeView에서 에러 발생 시 toast 표시
- [ ] ReservationManageView에서 작업 중 버튼 비활성화
- [ ] TrainerScheduleView에서 휴무일 토글 중 버튼 비활성화
